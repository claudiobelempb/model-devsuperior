...
public class ProductImageDTO implements Serializable {
  ...
  public ProductImageDTO(Long id, String code, String name, Instant createdAt, Instant updatedAt, EnumStatus status) {
    this.id = id;
    this.code = code;
    this.name = name;
  ...
  public ProductImageDTO(ProductImage entity, Set<Product> products) {
    this(entity);
